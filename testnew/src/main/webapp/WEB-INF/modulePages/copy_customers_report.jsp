...
<tr> 
	...
	<tr> 
		...
		<td valign='top' align="right"><s:a href="#" onclick="adjustHeight('ttextMain', '%{#status.index}')" id='xtextMain%{#status.index}'><img id='<s:property value='%{#status.index}'/>' src="images/buttons/plus.gif" border=0/></s:a></td>
     ...
     <s:iterator value="medicineDetails" >
      <tr  style="display: none;" id="ttextMain<s:property value="#status.count" />" >
...
function adjustHeight(event, id){debugger;
var nid = parseInt(id)+1;
var obj = document.getElementById(event+nid);
var plus = document.getElementById(id);
if(obj.style.display == "block"){
	plus.src = "images/buttons/plus.gif";
	obj.style.display = "none";
	
} else {
	plus.src = "images/buttons/minus.gif";
