...
<tr><td></td><td><s:textfield name="medicineInfo.quantity" label="Quantity"/></td></tr>
 ...
 <tr><td></td><td><input name="pdt_submitButton" type="image" src='<s:url value="/images/buttons/update.bmp"/>' /></td>
 </tr>
 ...
 <s:if test="isformShow('delete')">
<form action="delete">
<tr><td>
 <s:select name="medicineInfo.productName" list="productList" onchange="getAjaxCalDel(this)" headerKey = "" headerValue="" label="Product Name"/>
</td></tr>
<tr><td></td><td><s:textfield name="medicineInfo.quantity" label="Quantity"/></td></tr>
 <tr><td></td><td> <s:textfield name="medicineInfo.pricePerUnit" label="Price Per Unit" /></td></tr>
 <tr><td></td><td><input name="pdt_submitButton" type="image" src='<s:url value="/images/buttons/delete.bmp"/>' /></td>
 </tr>
 <s:hidden name= "medicineInfo.productId" />
 <s:hidden name= "medicineInfo.productCategory" />
 <s:hidden name= "medicineInfo.companyName" />
